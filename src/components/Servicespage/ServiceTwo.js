                    ...
                    <Col>
                        <Card className="srvc2-card-mdiv" ><Link className='srvc2-link-tag'  to="/appdevelopment">
                            ...
                            <Card.Body>
                                ...
                                <Card.Text className="srvc2-card-tagline">
                                We provide suprerior performance web applications that are compatible with all devices.
                                </Card.Text>
                    ...
                    <Col>
                        <Card className="srvc2-card-mdiv" ><Link className='srvc2-link-tag'  to="/graphicdesign">
                            ...
                            <Card.Body>
                                ...
                                <Card.Text className="srvc2-card-tagline">
                                We create attaractive and beautiful designs that provides unique image for your business. 
                                </Card.Text>
                    ...
                    <Col>
                        <Card className="srvc2-card-mdiv" ><Link className='srvc2-link-tag'  to="/digitalmarket">
                            ...
                            <Card.Body>
                                ...
                                <Card.Text className="srvc2-card-tagline">
                                   We help your business to grow with our digital marketing experts by finding your pottential customers
                                </Card.Text>
